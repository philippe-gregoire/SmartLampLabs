...
* Accept the default organization and space ![](images_Lab4/markdown-img-paste-20180416174319435.png). Lite accounts can have only one organization anyhow. Click `Continue`
* Once the account is created, follow with `Get Started` button ![](assets/markdown-img-paste-20180416174228637.png).
